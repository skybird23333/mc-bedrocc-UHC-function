execute @s[tag=hs,scores={sst=1}] ~~~ scoreboard players set @s settings_time 0
execute @s[tag=hs,scores={sst=1}] ~~~ tellraw @a {"rawtext":[{"text":"Changed game mode to §earcade§f."}]}
