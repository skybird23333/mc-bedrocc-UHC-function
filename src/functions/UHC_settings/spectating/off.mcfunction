execute @s[tag=host,scores={settings_state=1}] ~~~ scoreboard players set @s settings_spectate 0
execute @s[tag=host,scores={settings_state=1}] ~~~ tellraw @a {"rawtext":[{"text":"Turned §eoff§f spectating."}]}
