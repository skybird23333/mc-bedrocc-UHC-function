...
execute @s[tag=host,scores={settings_state=2,timer=35950}] ~~~ scoreboard players set "§r " display -4
...
execute @s[tag=host,scores={settings_state=2,timer=35950}] ~~~ scoreboard players set "§a9 minutes!" display -3
execute @s[tag=host,scores={settings_state=2,timer=35400}] ~~~ scoreboard players reset "§a9 minutes!" display
execute @s[tag=host,scores={settings_state=2,timer=35400}] ~~~ scoreboard players set "§a8 minutes!" display -3
execute @s[tag=host,scores={settings_state=2,timer=34800}] ~~~ scoreboard players reset "§a8 minutes!" display
execute @s[tag=host,scores={settings_state=2,timer=34800}] ~~~ scoreboard players set "§a7 minutes!" display -3
execute @s[tag=host,scores={settings_state=2,timer=34200}] ~~~ scoreboard players reset "§a7 minutes!" display
execute @s[tag=host,scores={settings_state=2,timer=34200}] ~~~ scoreboard players set "§a6 minutes!" display -3
execute @s[tag=host,scores={settings_state=2,timer=33600}] ~~~ scoreboard players reset "§a6 minutes!" display
execute @s[tag=host,scores={settings_state=2,timer=33600}] ~~~ scoreboard players set "§a5 minutes!" display -3
execute @s[tag=host,scores={settings_state=2,timer=33000}] ~~~ scoreboard players reset "§a5 minutes!" display
execute @s[tag=host,scores={settings_state=2,timer=33000}] ~~~ scoreboard players set "§a4 minutes!" display -3
execute @s[tag=host,scores={settings_state=2,timer=32400}] ~~~ scoreboard players reset "§a4 minutes!" display
execute @s[tag=host,scores={settings_state=2,timer=32400}] ~~~ scoreboard players set "§a3 minutes!" display -3
execute @s[tag=host,scores={settings_state=2,timer=31800}] ~~~ scoreboard players reset "§a3 minutes!" display
execute @s[tag=host,scores={settings_state=2,timer=31800}] ~~~ scoreboard players set "§a2 minutes!" display -3
execute @s[tag=host,scores={settings_state=2,timer=31200}] ~~~ scoreboard players reset "§a2 minutes!" display
execute @s[tag=host,scores={settings_state=2,timer=31200}] ~~~ scoreboard players set "§a1 minutes!" display -3
...
#daylight cycle module
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=8400}] ~~~ scoreboard players set "Sun set in" display -5

execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=8400}] ~~~ scoreboard players set "§17 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=7800}] ~~~ scoreboard players reset "§17 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=7800}] ~~~ scoreboard players set "§16 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=7200}] ~~~ scoreboard players reset "§16 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=7200}] ~~~ scoreboard players set "§15 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=6600}] ~~~ scoreboard players reset "§15 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=6600}] ~~~ scoreboard players set "§14 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=6000}] ~~~ scoreboard players reset "§14 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=6000}] ~~~ scoreboard players set "§13 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=5400}] ~~~ scoreboard players reset "§13 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=5400}] ~~~ scoreboard players set "§12 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=4800}] ~~~ scoreboard players reset "§12 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=4800}] ~~~ scoreboard players set "§11 minute" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=4200}] ~~~ scoreboard players reset "§11 minute" display

execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=4200}] ~~~ scoreboard players reset "Sun set in"
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=4200..4300}] ~~~ time add 120
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=4200}] ~~~ scoreboard players set "Sun rise in" display -5

execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=4200}] ~~~ scoreboard players set "§47 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=3600}] ~~~ scoreboard players reset "§47 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=3600}] ~~~ scoreboard players set "§46 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=3000}] ~~~ scoreboard players reset "§46 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=3000}] ~~~ scoreboard players set "§45 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=2400}] ~~~ scoreboard players reset "§45 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=2400}] ~~~ scoreboard players set "§44 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=1800}] ~~~ scoreboard players reset "§44 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=1800}] ~~~ scoreboard players set "§43 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=1200}] ~~~ scoreboard players reset "§43 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=1200}] ~~~ scoreboard players set "§42 minutes" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=600}] ~~~ scoreboard players reset "§42 minutes" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=600}] ~~~ scoreboard players set "§41 minute" display -6
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=..1}] ~~~ scoreboard players reset "§41 minute" display

execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=..0}] ~~~ scoreboard players reset "Sun rise in" display
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=0..}] ~~~ scoreboard players remove @s day_timer 1
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=0..100}] ~~~ time add 120
execute @s[tag=host,scores={settings_state=2,timer=0..,day_timer=..0}] ~~~ scoreboard players set @s day_timer 8400