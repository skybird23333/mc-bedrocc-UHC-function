...
execute @a[tag=host,scores={timer=0..,settings_state=2,spec_timeout=..0}] ~~~ tag @a remove spec
execute @a[tag=host,scores={timer=0..,settings_state=2,spec_timeout=..0}] ~~~ tag @r[tag=!dead] add spec
